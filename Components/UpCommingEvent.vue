<template>
  <div id="event" class="lg:py-16 xl:py-16 py-4 bg-[#faf9f9] bg-center object-center w-full lg:space-y-16 xl:space-y-16 space-y-4" style="background: url('/imgs/glows/01.png') no-repeat top left;">
    <div class="wrapper">
      ...
      <div class="lg:py-7 xl:py-7 up-coming-event-container">
        <Swiper :breakpoints="breakpoints" :modules="modules" :autoplay="true" :loop="true" @slideChange="onSlideChange" @init="onInit" :slides-per-view="2" :slides-per-group="1">
